      ...
      <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-10">
        ...
        <div className="mt-14 grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-8">
          <div className="rounded-[24px] bg-white p-6 sm:p-8 lg:p-10 shadow-sm">
            ...
            <p className="mt-5 text-[#5b5b5b] text-[15px] sm:text-[16px] leading-8">
          ...
          <div className="rounded-[24px] bg-[#E5D3AC] p-6 sm:p-8 lg:p-10 shadow-sm">
            <h2 className="font-serif text-[28px] sm:text-[34px] text-[#2f2f2f]">
              Our Mission
            </h2>
            ...
            <h2 className="mt-8 font-serif text-[28px] sm:text-[34px] text-[#2f2f2f]">
              Our Vision
            </h2>
        ...
        <div className="mt-16">
          <div className="text-center">
            <h2 className="font-serif text-[30px] sm:text-[36px] lg:text-[44px] text-[#2f2f2f]">
              Why Choose Us
            </h2>
          ...
          <div className="mt-10 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5 sm:gap-6">
            {values.map((item) => {
              ...
              return (
                <div
                  key={item.id}
                  className="rounded-[22px] bg-white p-6 sm:p-7 text-center shadow-sm"
                >
                  <div className="w-14 h-14 mx-auto rounded-full bg-[#103258]/10 flex items-center justify-center">
                    <Icon className="text-[#103258]" size={26} />
                  </div>

                  <h3 className="mt-5 text-[18px] sm:text-[20px] font-medium text-[#333]">
                    {item.title}
                  </h3>
