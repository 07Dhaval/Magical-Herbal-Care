...
export default function EditProduct() {
    ...
    const fetchProduct = async () => {
      ...
      if (data.success && data.product) {
        ...
        setForm({
          ...
          price: product.price || "",
          intro: desc.intro || "",
          ingredients: Array.isArray(desc.ingredients) ? desc.ingredients.join("\n") : "",
          process: desc.process || "",
          benefits: Array.isArray(desc.benefits) ? desc.benefits.join("\n") : "",
          note: desc.note || "",
          suitable: desc.suitable || "",
        });

        setOldImages([imgs[0] || "", imgs[1] || "", imgs[2] || ""]);
        setPreviewImages([imgs[0] || "", imgs[1] || "", imgs[2] || ""]);
      }
    };
  ...
  return (
    <AdminLayout>
      <h1 className="text-3xl font-bold text-[#2f4f2f] mb-6">Edit Product</h1>
